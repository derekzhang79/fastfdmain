...
private:
    ...
    //会员卡积分类型
    static QStandardItemModel VIP_MODEL_POINT_CH_TYPE;//t_m_point ch_type
    //充值支付方式
...
public:
    //会员状态对照表
    static QStandardItemModel& get_VIP_MODEL_STATE();//t_m_member, ch_state
    //持卡状态对照表
    ...
    //会员卡会员价
    static QStandardItemModel& get_VIP_MODEL_M_PRICE();//t_m_member_type ch_calc_type
    //会员卡积分
    ...
    //会员卡积分类型
    static QStandardItemModel& get_VIP_MODEL_POINT_CH_TYPE();//t_m_point ch_type
    //充值支付方式
