...
public:
    static const lds_bool is_yun_member;//对这儿的会员是否是云端，这里需要开启和关闭功能
...
public slots:
    ...
    //外部调用读卡例子
    static bool static_to_memeber_readcard(QWidget *parent, QString &cardid, uo_rw_member &uo_member, bool ispay=false, bool isyun=false);
    static bool static_to_memeber_readcard_d(QWidget *parent, QString &cardid, uo_rw_member &uo_member, bool search_member, vch_membernoData::chooseFlag choose/*0选择、1本地会员、2云会员*/);
...
class w_m_member_list_yunlock{
public:
    w_m_member_list_yunlock();
    ~w_m_member_list_yunlock();
};
...
class w_m_member_list_sendcard : public QDialog{
    Q_OBJECT
public:
    explicit w_m_member_list_sendcard(QWidget *parent ,
...
class w_m_member_list_yun_sendcard : public QDialog{
    Q_OBJECT
public:
    explicit w_m_member_list_yun_sendcard(QWidget *parent);
