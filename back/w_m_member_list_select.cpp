    ...
    ui(new Ui::w_m_member_list_select)
{
    ...
    tablemodel->save_set_header("vch_member", tr("会员"));
    tablemodel->save_set_header("ch_typeno", tr("类型"));
    tablemodel->save_set_header("vch_handtel", tr("手机号"));
