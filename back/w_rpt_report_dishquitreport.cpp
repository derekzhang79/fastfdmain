...
void w_rpt_report_dishquitreport::tab1sqlinit()
{
    tab1info.insert(tr("按菜品类型"),
                    w_rpt_report::TABTYPE(QStringList()<<tr("菜品类型")<<tr("品码")<<tr("品名")<<tr("单位")<<tr("均价")<<tr("数量")<<tr("金额")<<tr("折扣")<<tr("赠送额")<<tr("实际金额"),
                                          QString("select "
    ...
    tab1info.insert(tr("按餐桌"),
                    w_rpt_report::TABTYPE(QStringList()<<tr("餐桌")<<tr("品码")<<tr("品名")<<tr("单位")<<tr("均价")<<tr("数量")<<tr("金额")<<tr("折扣")<<tr("赠送额")<<tr("实际金额"),
    ...
    tab1info.insert(tr("按餐桌类型"),
                    w_rpt_report::TABTYPE(QStringList()<<tr("餐桌类型")<<tr("品码")<<tr("品名")<<tr("单位")<<tr("均价")<<tr("数量")<<tr("金额")<<tr("折扣")<<tr("赠送额")<<tr("实际金额"),
                                          QString("select "
    ...
    tab1info.insert(tr("按退菜人"),
                    w_rpt_report::TABTYPE(QStringList()<<tr("退菜人")<<tr("品码")<<tr("品名")<<tr("单位")<<tr("均价")<<tr("数量")<<tr("金额")<<tr("折扣")<<tr("赠送额")<<tr("实际金额"),
                                          QString("select "
    ...
    tab1info.insert(tr("按退菜明细查询"),
                    w_rpt_report::TABTYPE(QStringList()<<tr("退菜类型")<<tr("品码")<<tr("品名")<<tr("单位")<<tr("均价")<<tr("数量")<<tr("金额")<<tr("折扣")<<tr("赠送额")<<tr("实际金额")<<tr("退菜人")<<tr("退菜时间")<<tr("退菜原因"),
                                          QString (
                                              "SELECT '"+tr("点单退菜")+"' as 'dish_typeno',"
                                              ...
                                              " SELECT '"+tr("快餐反结账")+"' as 'dish_typeno',"
