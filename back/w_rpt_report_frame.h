...
public:
    ...
    ~w_rpt_report_frame();
    static const QMap<QString, QString> &variant_transfer_map();
    static void clearCache();
    static int doubleValueDecimal(const QString &map_chinese_value);

    static QString headdata_transfer(const QVariant &dd);
