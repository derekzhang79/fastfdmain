                       ...
                       << tr("菜品销售排行统计"), parent)
{
    ...
    ui_help->comboBox_group->addItem(tr("按菜品明细"), "a.ch_dishno, vch_dishname , cey_bt_dish a");
    ui_help->comboBox_group->addItem(tr("按菜品类型"), "c.ch_dish_typeno, vch_dish_typename , cey_bt_dish_type c");
    ui_help->comboBox_group->addItem(tr("按菜品小类"), "c.ch_sub_typeno, vch_sub_typename , cey_bt_dish_subtype c");
    ui_help->comboBox_group->addItem(tr("按餐桌号"), "d.ch_tableno, vch_tablename, cey_bt_table d");
    ui_help->comboBox_group->addItem(tr("按餐桌类型"), "e.ch_typeno, vch_typename, cey_bt_table_type e");
