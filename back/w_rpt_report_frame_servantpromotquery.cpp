                       ...
                       << tr("服务员提成收银查询"), parent)
{
    ...
    ui_help->comboBox_servant->addItemsBySql("Select '' as vch_operID,'" + tr("全部") + "' as vch_operator union  Select '0000' as vch_operID,'system' as vch_operator union Select vch_operID, ifnull(vch_operator, '') as vch_operator from cey_sys_operator where ch_flag = 'Y' and ch_waiter = 'Y' ");
