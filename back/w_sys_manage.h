...
public:
    ...
    ///基础资料
    //1
    static cJSON * q_bt_get_piece_cey_bt_dish(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_dish(qrtVariantPairList &key_value_list, cJSON *pItem);
    //2
    static cJSON * q_bt_get_piece_cey_bt_dish_subtype(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_dish_subtype(qrtVariantPairList &key_value_list, cJSON *pItem);
    //3
    static cJSON * q_bt_get_piece_cey_bt_dish_type(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_dish_type(qrtVariantPairList &key_value_list, cJSON *pItem);
    //4
    static cJSON * q_bt_get_piece_cey_bt_dish_suit(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_dish_suit(qrtVariantPairList &key_value_list, cJSON *pItem);
    //5
    static cJSON * q_bt_get_piece_cey_bt_suit_change(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_suit_change(qrtVariantPairList &key_value_list, cJSON *pItem);
    //6
    static cJSON * q_bt_get_piece_cey_bt_unit(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_unit(qrtVariantPairList &key_value_list, cJSON *pItem);
    //7
    static cJSON * q_bt_get_piece_cey_bt_table(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_table(qrtVariantPairList &key_value_list, cJSON *pItem);
    //8
    static cJSON * q_bt_get_piece_cey_bt_table_type(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_table_type(qrtVariantPairList &key_value_list, cJSON *pItem);
    //9
    static cJSON * q_bt_get_piece_cey_bt_table_area(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_table_area(qrtVariantPairList &key_value_list, cJSON *pItem);
    //10
    static cJSON * q_bt_get_piece_cey_bt_cp_dish(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_cp_dish(lds_query &sqlQuery, cJSON *pItem);
    static void q_bt_put_piece_cey_bt_cp_dish(qrtVariantPairList &key_value_list, cJSON *pItem);
    //11
    static cJSON * q_bt_get_piece_cey_bt_cp_memo(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_cp_memo(qrtVariantPairList &key_value_list, cJSON *pItem);
    //12
    static cJSON * q_bt_get_piece_cey_bt_cp_type(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_cp_type(qrtVariantPairList &key_value_list, cJSON *pItem);
    //13
    static cJSON * q_bt_get_piece_cey_bt_dish_warn(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_dish_warn(qrtVariantPairList &key_value_list, cJSON *pItem);
    //14
    static cJSON * q_bt_get_piece_cey_bt_paymode(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_bt_put_piece_cey_bt_paymode(qrtVariantPairList &key_value_list, cJSON *pItem);
    //15
    static cJSON * q_bt_get_piece_material_bt_dish(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    ...
    ///会员
    //1
    static cJSON * q_m_get_piece_t_m_member_type(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_m_put_piece_t_m_member_type(qrtVariantPairList &key_value_list, cJSON *pItem);
    //2
    static cJSON * q_m_get_piece_t_m_member(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_m_put_piece_t_m_member(qrtVariantPairList &key_value_list, cJSON *pItem);
    //3
    static cJSON * q_m_get_piece_t_m_gift(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_m_put_piece_t_m_gift(qrtVariantPairList &key_value_list, cJSON *pItem);
    //4

    static cJSON * q_m_get_piece_t_m_curamount(lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
    static void q_m_put_piece_t_m_curamount(qrtVariantPairList &key_value_list, cJSON *pItem);
    //5
    static cJSON * q_m_get_piece_t_m_parameter(lds_query &query, const QString &orgCode);//-1删除、 0正常使用
