...
public:
    ...
    cJSON * q_u_get_piece_cey_u_checkout_master(lds_query &query, const QString &orgCode);
    cJSON * q_u_get_piece_cey_u_master(lds_query &query, const QString &orgCode);
    cJSON * q_u_get_piece_cey_u_table(lds_query &query, const QString &orgCode);
    cJSON * q_u_get_piece_cey_u_orderdish(lds_query &query, const QString &orgCode);
    cJSON * q_u_get_piece_cey_u_checkout_detail(lds_query &query, const QString &orgCode);
...
public:
    //! 会员部分
    static cJSONHttpData get_yun_httppos(QWidget *parent, const QString &http_key,
                                                                    const QString &param,
    ...
    static cJSONHttpData get_yun_httpget( QWidget *parent,const QString &http_key,
                                  const QMap<QString, QString> &headInfo,
                                  QString &retparam,//返回json数据
                                  const QString &msgtitle,
                                  bool ispop=true,
...
public:
    ...
    static bool get_yun_member_parameter(const QString &key, QString &retValue, QString &retErr);
    //获取会员读卡
    ...
    //获取会员最大订单号
    static QString get_yun_member_maxorderno(QWidget *parent, const QString &key, const QString &flag,/*获取单号，中餐是Z；快餐是F*/
                                             bool &ok, const QString &def="");
    //获取会员最大支付号
    static QString get_yun_member_maxmasterno(QWidget *parent, const QString &key, const QString &flag, bool &ok, const QString &def="");
    //获取会员类型
    ...
    //获取会员类型
    static bool get_yun_member_membertypelist(QWidget *parent, QMap<QString, QVariant> &retlist);
    //提交关于会员的信息
    ...
    //提交关于会员的新增
    static bool get_yun_member_add(QWidget *parent, const membernewparam &value);
    //提交关于会员的新增
    ...
    //根据条件检索会员
    static bool get_yun_member_byanyvchmemberno(QWidget *parent ,const QString &cardNo, membernewparam &arg0);
    //云会员增减积分
    ...
    static member_r_f_b_info  get_yun_member_r_f_b(QWidget *parent,const QString &operId,const QString &dateStart, const QString &dateEnd, bool &ok);
    //释放json
...
private:
    ...
    static cJSON *json_yun_readcard_select;
};
