...
void w_sys_manage_cloudsync_with_time::tousercheck()
{
    ...
    QString httpkey="http://" + ui->comboBox_ip->currentText()+
            "/CateSystem/account/getOrgCode-account";
    QMap<QString, QString> headInfo;

    headInfo.insert("userName",ui->lineEdit_user->text().toLocal8Bit().data());
    headInfo.insert("password",ui->lineEdit_password->text().toLocal8Bit().data());

    //!等待
    lds_messagebox_loading_show loading(this, "WAITING...", "WAITING...");
    loading.show();
    //!~等待
    cJSONHttpData json_yun_parameter=w_sys_manage_cloudsync::get_yun_httpget(this, httpkey, headInfo,tr("验证"), true, false, 5*1000);
...
{
    if(0 == lds_messagebox::information(this, MESSAGE_TITLE_VOID, tr("终端号")+":"+saas_pay_detail::terminalCodeGet(), tr("升级"), tr("取消"))) {
        if(saas_pay_detail::saas_type() == "") {
            saas_guide2 d(new saas_guide_activateTerminal);
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_bt_get_piece_(const QString &tablename, lds_query &query, const QString &orgCode, int state)
{
...
int w_sys_manage_cloudsync_with_time_running::get_state_local_dish_base_keepdata()
{
    ...
    QString http_key="http://" + n_func::f_get_sysparm("cloud_ip")+
            "/CateSystem/arm/dish-base/getVersion-rest";

    w_sys_manage_cloudsync_transfer transfer;
    cJSONHttpData ret_json_err  = transfer.sendGet(http_key, headInfo,retparam, 20*60*1000);
    ...
    while(query.next()) {
        cJSON *item = cJSON_GetObjectItem(ret_json_err.json, query.recordValue("vch_sqltablename_yun_version").toByteArray().data());
        if(item == 0) {
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_bt_get_table_version_array(lds_query &query)
{
...
bool w_sys_manage_cloudsync_with_time_running::q_st_upload_material_num(lds_query &query, const QString &orgCode)
{
    QMap<QString, QString> headInfo;
    headInfo.insert("orgCode",n_func::f_get_sysparm("orgCode"));
    headInfo.insert("userName",n_func::f_get_sysparm("cloud_user"));
    ...
    QString httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
            "/CateSystem/arm/dish-base/update-rest";

    cJSON *root = cJSON_CreateObject();
    cJSON_auto_del d(root);
    cJSON *root_array = cJSON_CreateArray();
    cJSON_AddItemToObject(root, "dishInfoList", root_array);
    query.execSelect(QString("SELECT * from cey_st_material_num "));
    //ch_materialno, num_num
    while(query.next()) {
        cJSON *item = cJSON_CreateObject();
        cJSON_AddItemToArray(root_array, item);
        cJSON_help::filter_cJSON_AddStringToObject(item, "diChDishNo", query.recordValue("ch_materialno"));
        cJSON_help::filter_cJSON_AddStringToObject(item, "inventory", query.recordValue("num_num"));

        cJSON_help::filter_cJSON_AddStringToObject(item, "orgCode", orgCode);
    }

    QString param = cJSON_help::getcJSONprint(root);
    cJSONHttpData json_yun_parameter=w_sys_manage_cloudsync::get_yun_httppos(0, httpkey, param, headInfo,tr("云同步"));
    if(200 == json_yun_parameter.httpStatus) {
        return true;
    }
    return false;
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_checkout_detail(lds_query &query, const QString &orgCode)
{

    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codIntFlowId", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codChPayModeNo", query.recordValue("ch_paymodeno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumPayAmount", query.recordValue("num_payamount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumChange", query.recordValue("num_change"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumRealAmount", query.recordValue("num_realamount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumFace", query.recordValue("num_face"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codVchVoucherNo", query.recordValue("vch_voucherno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codVchMemo", query.recordValue("vch_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumCardRemain", query.recordValue("num_card_remain"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "codNumFaceNum", query.recordValue("num_face_Num"));

    cJSON_help::filter_cJSON_AddStringToObject(pItem, "orgCode", orgCode);
    cJSON_help::_cJSON_AddStringToObject(pItem, "terminalCode", query.recordValue("terminal_code"));


    return pItem;
}

cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_checkout_master(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();

    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comChBillNo", query.recordValue("ch_billno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comChTableNo", query.recordValue("ch_tableno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumCost", query.recordValue("num_cost"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumDiscount", query.recordValue("num_discount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumPresent", query.recordValue("num_present"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumService", query.recordValue("num_service"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumLowCost", query.recordValue("num_lowcost"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumBlotout", query.recordValue("num_blotout"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumFree",query.recordValue("num_free"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comVchFreeOperId", query.recordValue("vch_free_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumCash", query.recordValue("num_cash"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumOther", query.recordValue("num_other"));

    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumRun", query.recordValue("num_run"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comVchRunOperId", query.recordValue("vch_run_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comChState", query.recordValue("ch_state"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comVchOperId2", query.recordValue("vch_operID2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comDtOperDate2", query.recordValue("dt_operdate2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comChType", query.recordValue("ch_type"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "comNumRate", query.recordValue("num_rate"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_orderdish(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdIntFlowId", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChBillNo", query.recordValue("ch_billno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChTableNo", query.recordValue("ch_tableno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdIntId", query.recordValue("int_id"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChDishNo", query.recordValue("ch_dishno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdNumPrice", query.recordValue("num_price"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdNumPriceOrg", query.recordValue("num_price_org"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdNumPriceAdd", query.recordValue("num_price_add"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdNumNum", query.recordValue("num_num"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdNumBack", query.recordValue("num_back"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdVchBackOperId", query.recordValue("vch_back_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdDtBackOperDate", query.recordValue("dt_back_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdIntDiscount", query.recordValue("int_discount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdVchDisOperId", query.recordValue("vch_dis_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdDtDisOperDate", query.recordValue("dt_dis_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "btVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChConsult", query.recordValue("ch_consult"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChPrintFlag", query.recordValue("ch_printflag"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdVchPrintMemo", query.recordValue("vch_print_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "dcChSuitFlag", query.recordValue("ch_suitflag"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "dcChSuitNo", query.recordValue("ch_suitno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChSpecialFlag", query.recordValue("ch_specialflag"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chPresentFlag", query.recordValue("ch_presentflag"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdVchPreOperId", query.recordValue("vch_pre_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdDtPreOperDate", query.recordValue("dt_pre_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChTogoNo", query.recordValue("ch_togono"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "bdChOutFlag", query.recordValue("ch_outflag"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_service_low(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slChType", query.recordValue("ch_type"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slNumAmount", query.recordValue("num_amount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slChState", query.recordValue("ch_state"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "slVchMemo", query.recordValue("vch_memo"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_orderdish_log(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlIntFlowId", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlChType", query.recordValue("ch_type"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlVchImpower", query.recordValue("vch_impower"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlVchReason", query.recordValue("vch_reason"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlVchMemo", query.recordValue("vch_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "odlIntOrderFlow", query.recordValue("int_orderflow"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_togo(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chTogono", query.recordValue("ch_togono"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chBillno", query.recordValue("ch_billno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chPayno", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numCost", query.recordValue("num_cost"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numDiscount", query.recordValue("num_discount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numPresent", query.recordValue("num_present"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numBlotout", query.recordValue("num_blotout"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchWaiter", query.recordValue("vch_waiter"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchAddress", query.recordValue("vch_address"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchLinkman", query.recordValue("vch_linkman"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchTel", query.recordValue("vch_tel"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chState", query.recordValue("ch_state"));
    ...
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numRate", query.recordValue("num_rate"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_table(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chBillno", query.recordValue("ch_billno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chTableno", query.recordValue("ch_tableno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "intPerson", query.recordValue("int_person"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchMemo", query.recordValue("vch_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chState", query.recordValue("ch_state"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chPayno", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "dtOperdate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchOperId2", query.recordValue("vch_operID2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "dtOperdate2", query.recordValue("dt_operdate2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "chOrderState", query.recordValue("ch_order_state"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numCost", query.recordValue("num_cost"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "vchWaiter", query.recordValue("vch_waiter"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "numTransService", query.recordValue("num_trans_service"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_cey_u_master(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omChBillNo", query.recordValue("ch_billno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omChState", query.recordValue("ch_state"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omVchOperId2", query.recordValue("vch_operID2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omDtOperDate2", query.recordValue("dt_operdate2"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "omVchMemo", query.recordValue("vch_memo"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_t_m_deposit(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdIntFlowId", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdNumDeposit", query.recordValue("num_deposit"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdNumRealaMount", query.recordValue("num_realamount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdChDepositMode", query.recordValue("ch_deposit_mode"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdChPayMode", query.recordValue("ch_pay_mode"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "dtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdVchMemo", query.recordValue("vch_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mdRemainAmt", query.recordValue("remain_amt"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_t_m_point(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpIntFlowId", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpChType", query.recordValue("ch_type"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpNumPoint", query.recordValue("num_point"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpVchMemo", query.recordValue("vch_memo"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpDtOperDate", query.recordValue("dt_operdate"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_t_m_pay(lds_query &query, const QString &orgCode)
{
    cJSON *pItem = cJSON_CreateObject();
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "intFlowid", query.recordValue("int_flowID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpVchMemberNo", query.recordValue("vch_memberno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpChPayNo", query.recordValue("ch_payno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpChPayModeNo", query.recordValue("ch_paymodeno"));

    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpNumAmount", query.recordValue("num_amount"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpNumPay", query.recordValue("num_pay"));

    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpVchOperId", query.recordValue("vch_operID"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpDtOperDate", query.recordValue("dt_operdate"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpChBalanceNo", query.recordValue("ch_balanceno"));
    cJSON_help::filter_cJSON_AddStringToObject(pItem, "mpIntCheckFlow", query.recordValue("int_checkflow"));
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_u_get_piece_(const QString &tablename, lds_query &query, const QString &orgCode)
{
...
bool w_sys_manage_cloudsync_with_time_running::q_u_put_by(const QString &ch_payno)
{
    ...
    //    cey_u_checkout_detail-----------------------checkOutDetail
    if(!query.execUpdate("cey_u_checkout_detail", "ch_yun_already_keep", "Y", QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_checkout_master-----------------------checkOutMaster
    if(!query.execUpdate("cey_u_checkout_master", "ch_yun_already_keep", "Y", QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_orderdish-----------------------orderDish
    if(!query.execUpdate("cey_u_orderdish", "ch_yun_already_keep", "Y",       QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_service_low-----------------------serviceLow
    if(!query.execUpdate("cey_u_service_low", "ch_yun_already_keep", "Y",     QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_orderdish_log-----------------------orderDishLog
    if(!query.execUpdate("cey_u_orderdish_log", "ch_yun_already_keep", "Y",   QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_togo-----------------------toGo
    if(!query.execUpdate("cey_u_togo", "ch_yun_already_keep", "Y",            QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;
    //    cey_u_table-----------------------tableRecordsConsumption
    if(!query.execUpdate("cey_u_table", "ch_yun_already_keep", "Y",           QString("ch_payno = '%1' and ifnull(ch_yun_already_keep,'') <> 'Y' ").arg(ch_payno))) return false;

    return true;
}

void w_sys_manage_cloudsync_with_time_running::q_u_get_limit1000(cJSON *root, const QString &orgCode, QString &dt_operdate)
{
    dt_operdate = "";
    cJSON *root_sub_array;
    lds_query query;
    ...
    //        cey_u_checkout_detail-----------------------checkOutDetail
    root_sub_array = cJSON_GetObjectItem(root, "checkOutDetail");
    query.execSelect(QString("select * from cey_u_checkout_detail where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100; "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_checkout_detail", query, orgCode));
    }
    //        cey_u_checkout_master-----------------------checkOutMaster
    ...
    root_sub_array = cJSON_GetObjectItem(root, "checkOutMaster");
    query.execSelect(QString("select * from cey_u_checkout_master where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100; "));
    while(query.next()) {
    ...
    root_sub_array = cJSON_GetObjectItem(root, "orderDish");
    query.execSelect(QString("select * from cey_u_orderdish where ifnull(ch_payno, '') <> '' and   ifnull(ch_yun_already_keep,'') <> 'Y' limit 100;"));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_orderdish", query, orgCode));
    }
    //        cey_u_service_low-----------------------serviceLow
    ...
    root_sub_array = cJSON_GetObjectItem(root, "serviceLow");
    query.execSelect(QString("select * from cey_u_service_low where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100; "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_service_low", query, orgCode));
    }
    //        cey_u_orderdish_log-----------------------orderDishLog
    ...
    root_sub_array = cJSON_GetObjectItem(root, "orderDishLog");
    query.execSelect(QString("select * from cey_u_orderdish_log where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100; "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_orderdish_log", query, orgCode));
    }
    //        cey_u_togo-----------------------toGo
    ...
    root_sub_array = cJSON_GetObjectItem(root, "toGo");
    query.execSelect(QString("select * from cey_u_togo where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100; "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_togo", query, orgCode));
    }
    //        cey_u_table-----------------------tableRecordsConsumption
    ...
    root_sub_array = cJSON_GetObjectItem(root, "tableRecordsConsumption");
    query.execSelect(QString("select * from cey_u_table where ifnull(ch_payno, '') <> '' and  ifnull(ch_yun_already_keep,'') <> 'Y' limit 100;  "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("cey_u_table", query, orgCode));
    }
    ...
    //t_m_deposit
    root_sub_array = cJSON_GetObjectItem(root, "memberDeposit");
    query.execSelect(QString("select * from t_m_deposit where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100;  "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("t_m_deposit", query, orgCode));
    }
    //t_m_point
    root_sub_array = cJSON_GetObjectItem(root, "memberPointList");
    query.execSelect(QString("select * from t_m_point where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100;  "));
    while(query.next()) {
        cJSON_AddItemToArray(root_sub_array, q_u_get_piece_("t_m_point", query, orgCode));
    }
    //t_m_pay
    root_sub_array = cJSON_GetObjectItem(root, "memberPay");
    query.execSelect(QString("select * from t_m_pay where ifnull(ch_yun_already_keep,'') <> 'Y' limit 100;  "));
    while(query.next()) {
...
cJSON *w_sys_manage_cloudsync_with_time_running::q_bt_get_table_cey(QObject *parent_nozero_trigger_slot, bool skip_ch_yun_already_keep_Y)
{
    ...
    while(query.next()) {
        ...
        /**/        if(parent_nozero_trigger_slot)QMetaObject::invokeMethod(parent_nozero_trigger_slot, "updateGoing",Qt::QueuedConnection,
                                                                            Q_ARG(QString, QString("%1-%2").arg(tr("获取上传数据") ).arg(tablename)),
                                                                            Q_ARG(int, keep_going++)
                                                                            );
        while(query2.next()) {
            ...
            /**/        if(parent_nozero_trigger_slot)QMetaObject::invokeMethod(parent_nozero_trigger_slot, "updateGoing",Qt::QueuedConnection,
                                                                                Q_ARG(QString, QString("%1-%2-%3").arg(tr("获取上传数据") ).arg(index).arg(tablename))
                                                                                );
        }
        //
        ...
        while(query2.next()) {
            ...
            /**/        if(parent_nozero_trigger_slot)QMetaObject::invokeMethod(parent_nozero_trigger_slot, "updateGoing",Qt::QueuedConnection,
                                                                                Q_ARG(QString, QString("%1-%2-%3").arg(tr("获取上传数据-删除") ).arg(index).arg(tablename))
                                                                                );
        }
        cJSON_AddItemToObject(root, vch_sqltablename_yun.toLocal8Bit().data(), root_sub_array);
        //
    }
    ///单独设置会员
    ...
    if(q_m_parameter_get_ready_total() > 0) {
        ...
        while (query.next()) {
            ...
            cJSON *item = cJSON_CreateObject();
            cJSON_help::filter_cJSON_AddStringToObject(item, "vchParameter", query.recordValue("vch_parameter"));
            cJSON_help::filter_cJSON_AddStringToObject(item, "vchValue", query.recordValue("vch_value"));
            cJSON_help::filter_cJSON_AddStringToObject(item, "vchExplain", query.recordValue("vch_explain"));
...
void w_sys_manage_cloudsync_with_time_running::tocancel()
{
    if(public_sql::save_login->yun_flow_upload_polling->isRunning()) {
        if(1 == lds_messagebox::question(this, MESSAGE_TITLE_VOID, tr("已上传的数据不会删除"), tr("确认"), tr("取消"))) return;
        public_sql::save_login->yun_flow_upload_polling->manual_stop();
        lds_messagebox::information(this, MESSAGE_TITLE_VOID, tr("操作取消"));
    }
    this->reject();
}
...
void w_sys_manage_cloudsync_with_time_running::data_run(cloudFlags f)
{
    ...
    if(f & cloud_up) {
        ...
        //!基本资料上传
        updateGoing(tr("获取上传数据"), keep_going++);
        cJSONHttpData json_yun_parameter = q_bt_get_table_cey(this, skip_ch_yun_already_keep_Y);
        QString param = json_yun_parameter.jsonToString();
        ...
        httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
                "/CateSystem/arm/dish-base/add-rest";
        updateGoing("开始上传", keep_going++);
        qDebug() << param;
        json_yun_parameter.initRef()=w_sys_manage_cloudsync::get_yun_httppos(this, httpkey, param, headInfo,tr("云同步"));
        if(200 != json_yun_parameter.httpStatus) {
            updateGoing(tr("云同步失败"));
            return;
        }
        ///单独设置库存
    ...
    if(f & cloud_down) {
        ...
        updateGoing(tr("下载前，获取本地版本号"), keep_going++);
        QString  headerversion;
        cJSONHttpData item_table_version = q_bt_get_table_version_array(query);
        headerversion = item_table_version.jsonToString();
...
//        headInfo.insert("machineCode","");
        ...
        httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
                "/CateSystem/arm/dish-base/get-rest";
        cJSONHttpData json_yun_parameter=w_sys_manage_cloudsync::get_yun_httpget(this, httpkey, headInfo,tr("云同步"));
...
void w_sys_manage_cloudsync_with_time_running::base_data_upload_thread()
{
    ...
    //!基本资料上传
    cJSONHttpData json_yun_parameter = q_bt_get_table_cey(0, false);
    QString param = json_yun_parameter.jsonToString();
    ...
    httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
            "/CateSystem/arm/dish-base/add-rest";
    json_yun_parameter.initRef()=w_sys_manage_cloudsync::get_yun_httppos(0, httpkey, param, headInfo,tr("云同步"));
    if(200 != json_yun_parameter.httpStatus) {
        return;
    }
...
//    headInfo.insert("machineCode","");
    ...
    httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
            "/CateSystem/arm/dish-base/get-rest";
    json_yun_parameter.initRef()=w_sys_manage_cloudsync::get_yun_httpget(0, httpkey, headInfo,tr("云同步"));
...
*/
    ...
    lds_query query;
    //x7
    loading->setText(QString("%1%").arg(int(100/10)));if(!query.execUpdate("cey_u_checkout_detail", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(200/10)));if(!query.execUpdate("cey_u_checkout_master", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(300/10)));if(!query.execUpdate("cey_u_orderdish", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(400/10)));if(!query.execUpdate("cey_u_service_low", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(500/10)));if(!query.execUpdate("cey_u_orderdish_log", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }

    loading->setText(QString("%1%").arg(int(600/10)));if(!query.execUpdate("cey_u_togo", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(700/10)));if(!query.execUpdate("cey_u_table", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }

    //x3

    loading->setText(QString("%1%").arg(int(800/10)));if(!query.execUpdate("t_m_deposit", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(900/10)));if(!query.execUpdate("t_m_point", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    loading->setText(QString("%1%").arg(int(1000/10)));if(!query.execUpdate("t_m_pay", "ch_yun_already_keep", "N", "", &errstring)) { lds_query::roll_back(); lds_messagebox::warning(parent, MESSAGE_TITLE_VOID, errstring);  return false;  }
    lds_query::com_mit();
    return true;
}
...
{
    w_sys_manage_cloudsync_transfer transfer;
    cJSON *root = q_u_get_by_ch_payno(ch_payno, pay_dt, orgCode);
    cJSON_auto_del d(root);
    QString retparam;
    ...
    QString httpkey="http://" + n_func::f_get_sysparm("cloud_ip")+
            "/CateSystem/arm/dish-flow/add-rest";
    QString param = cJSON_help::getcJSONprint(root);
    cJSONHttpData p = transfer.sendPost2(httpkey, param, headInfo,retparam, 5*1000);
...
void w_sys_manage_cloudsync_with_time_flow_upload_thread::run()
{
    ...
    //2
    {
        ...
        emit signalgoing(tr("上传"));
        while(false == isbreak
              && false == w_sys_manage_cloudsync_with_time_running::q_u_get_yun_already_keep()) {
            lds_query::tran_saction();
            cJSONHttpData root = w_sys_manage_cloudsync_with_time_running::q_u_get_void_flow_root();
            w_sys_manage_cloudsync_with_time_running::q_u_get_limit1000(root.json, orgCode, dt_operdate);
            if(false == w_sys_manage_cloudsync_with_time_running::q_u_put_limit1000(root.json)) {
                lds_query::roll_back();
                return;
            }
            QString param = root.jsonToString();
            qDebug() << __FUNCTION__ << param;
            cJSONHttpData p = transfer.sendPost2(httpkey, param, headInfo,retparam, 20*60*1000);
            if(200 != p.httpStatus) {
                emit signalgoing( tr("上传失败") +p.message + "\n"+ dt_operdate);
                lds_query::roll_back();
                return;
            }
            lds_query::com_mit();
            emit signalgoing( tr("正在上传流水") + "\n"+ dt_operdate);
        }
        if(isbreak) {
            emit signalgoing(tr("上传终止"));
        } else {
            emit signalgoing(tr("上传完成"));
        }
