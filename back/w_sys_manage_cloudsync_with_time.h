...
public:
    ...
    static cJSON *q_bt_get_piece_(const QString &tablename, lds_query &query, const QString &orgCode, int state);//-1删除、 0正常使用
...
public:
    ...
    //table vesion
    static cJSON * q_bt_get_table_version_array(lds_query &query);
    ...
    //只上传
    static bool q_st_upload_material_num(lds_query &query, const QString &orgCode);
    ///流水需要先开事务
    //    //x7
...
//x7
    ...
    */
    ...
    //x7
    static cJSON *q_u_get_piece_cey_u_checkout_detail(lds_query &query, const QString &orgCode);//checkOutDetail
    static cJSON *q_u_get_piece_cey_u_checkout_master(lds_query &query, const QString &orgCode);//checkOutMaster
    static cJSON *q_u_get_piece_cey_u_orderdish(lds_query &query, const QString &orgCode);//orderDish
    static cJSON *q_u_get_piece_cey_u_service_low(lds_query &query, const QString &orgCode);//serviceLow
    static cJSON *q_u_get_piece_cey_u_orderdish_log(lds_query &query, const QString &orgCode);//orderDishLog
    static cJSON *q_u_get_piece_cey_u_togo(lds_query &query, const QString &orgCode);//toGo
    static cJSON *q_u_get_piece_cey_u_table(lds_query &query, const QString &orgCode);//tableRecordsConsumption
    static cJSON *q_u_get_piece_cey_u_master(lds_query &query, const QString &orgCode);//orderMaster
    //x3
    static cJSON *q_u_get_piece_t_m_deposit(lds_query &query, const QString &orgCode);//memberDeposit
    static cJSON *q_u_get_piece_t_m_point(lds_query &query, const QString &orgCode);//memberPointList
    static cJSON *q_u_get_piece_t_m_pay(lds_query &query, const QString &orgCode);//memberPay

    static cJSON *q_u_get_piece_(const QString &tablename, lds_query &query, const QString &orgCode);//memberPay
    ...
    static void q_u_get_limit1000(cJSON *root, const QString &orgCode, QString &dt_operdate);
