...
class w_sys_manage_outer_pay_set : public lds_Dialog
{
    Q_OBJECT
...
public:
    ...
    static void addLanguageList(QComboBox *com);
    static QList<QPair<QString, QString> >& getLanguagelist();
    static QString getLanguageValue(const QString &key, bool skip_with_sys = false);
...
public:
    bool get_is_language_changed();
private:
    QString old_language;
