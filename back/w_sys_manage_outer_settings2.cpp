...
{
    ui->setupUi(this);
    ui->pushButton->setText(tr("结账打印机") + "\n" + "更多");
    ui->pushButton_2->setText(tr("开钱箱") + "\n" + "更多");
    ui->pushButton_3->setText(tr("厨房打印机") + "\n" + "更多");
    ui->pushButton_4->setText(tr("标签打印机") + "\n" + "更多");
    ui->pushButton_5->setText(tr("客显") + "\n" + "更多");
    ui->pushButton_6->setText(tr("副屏") + "\n" + "更多");
    ui->pushButton_7->setText(tr("前台计价秤") + "\n" + "更多");
    ui->pushButton_8->setText(tr("后台条码秤") + "\n" + "更多");
    ui->pushButton_9->setText(tr("无线点菜机") + "\n" + "更多");
    ui->pushButton_10->setText(tr("平板") + "\n" + "更多");
    ui->pushButton_11->setText(tr("厨显") + "\n" + "更多");
    ui->pushButton_12->setText(tr("电话盒") + "\n" + "更多");
