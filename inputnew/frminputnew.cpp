...
//         qDebug()<<"xuyao  xianshi  ruanjianpan"<<obj->objectName();

        if(obj->inherits("QLineEdit") || obj->inherits("QTextEdit") || obj->inherits("QPlainTextEdit") ||
                obj->inherits("QTextBrowser") || obj->inherits("QComboBox") || obj->inherits("QSpinBox")
                || obj->inherits("QDoubleSpinBox") || obj->inherits("QDateEdit") || obj->inherits("QTimeEdit")
