...
{
    model_cache->tablename_kvmap_clear_for_select_and_autoselect();
}
...
int lds_model_sqltablemodel_delegate_com::getType()
{
    return _type;
}
...
QString lds_model_sqltablemodel_delegate_com::paint_transfer(const QVariant &dd, const QString &field_name) const
{
    ...
    case 10:
    {
        value = fexpandmain_model_sqltablemodel::get_desc_vch_print_memo(key, 1, model_cache);
    }
        break;
...
void lds_model_sqltablemodel_delegate_com::disable_paint_transfer()
{
