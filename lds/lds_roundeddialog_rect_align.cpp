...
lds_roundeddialog_rect_align::lds_roundeddialog_rect_align(QDialog *buddy, bool show_title, bool clike_empty_reject)
    : lds_dialog_drog(buddy->parentWidget())
{
    this->clike_empty_reject = clike_empty_reject;
    ...
    if(show_title &&
        ...
        label_title = new lds_roundeddialog_title(this, buddy->windowTitle(), &titleColor);
...
void lds_roundeddialog_rect_align::enable_clike_empty_reject()
{
