    ...
    isfinishinput(false)
{
    ...
    printmodel_selfh_List = conf.value("labelprint_goodinfo_dialog/printmodel_selfh_List").toStringList();
    printmodel_selfh_conttent_List = conf.value("labelprint_goodinfo_dialog/printmodel_selfh_conttent_List").toStringList();
}
...
void labelprint_goodinfo_dialog::on_pushButton_print_project_self_clicked()
{
    ...
    if(QDialog::Accepted == dialog.exec()){
        ...
        conf.setValue("labelprint_goodinfo_dialog/printmodel_selfh_List", printmodel_selfh_List);
