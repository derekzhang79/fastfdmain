...
class lds_pushbuttonwithnofocusline;
...
public:
    ...
    static bool material_insert(lds_query &query, const QString &ch_billno, int int_id);
    ...
    static int to_m_read(QWidget *parent, fexpandmain_model_sqltablemodel_data *tablemodel, const QString &vch_memberno = "");
