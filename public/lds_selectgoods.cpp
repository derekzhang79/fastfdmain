    ...
    ui(new Ui_selectgoods_Widget)
{
    ...
    tablemodel->save_set_header(0,tr("品码"));
    tablemodel->save_set_header(1,tr("品名"));
    tablemodel->save_set_header(4,tr("大类"));
    tablemodel->save_set_header(14,tr("小类"));
...
void Selectgoods::setitem_flag(const QChar &flag)
{
    ...
    this->setWindowTitle(this->windowTitle()+tr("[直销商品]"));
...
void Selectgoods::setstcheck_sheetno()
{
    ...
    this->setWindowTitle(this->windowTitle()+tr("[盘点商品]"));
    toselect(ui->lineEdit->text());
}
