...
public:
    ...
    void setup(const QStringList &names,Qt::Alignment flag=Qt::AlignLeft,lds_keytoolbutton::KEYTYPE type = lds_keytoolbutton::NOKEY);
...
private:
    void layoutaddwidget(QBoxLayout *layout, const QStringList &names, Qt::Alignment flag,lds_keytoolbutton::KEYTYPE type);
private:
