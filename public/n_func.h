...
*/
    ...
    static QString f_get_sysparm_q(lds_query &query, const QString &as_parameter, const QVariant &as_default=QVariant());
    static QString f_set_sysparm_q(lds_query &query, const QString &as_parameter, const QVariant &as_value, const QString &as_memo=QString());
