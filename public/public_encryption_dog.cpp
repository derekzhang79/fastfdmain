...
public_encryption_dog::SOFTDOG_ER public_encryption_dog::conductlock()
{
    errsrring.clear();
    //1
#ifdef Q_OS_WIN
...
void public_encryption_dog::setDogID(const QString &id)
{
    *(QString *)&lds::dogID = id;
    qDebug() << "dogID:" << lds::dogID;
}
