    ...
    lds_pushbutton_wrap(parent)
{
    ...
    QString c0 = restraurantDelegate::color_light(
                restraurantDelegate::gettableState(tableState_KAITAI).colorname1,
                0).name();
    QString c3 = restraurantDelegate::color_light(
                restraurantDelegate::gettableState(tableState_KAITAI).colorname1,
                3).name();


    QString dis_c0 = restraurantDelegate::color_light(
                restraurantDelegate::gettableState(tableState_DISABLE).colorname1,
                0).name();
    QString dis_c3 = restraurantDelegate::color_light(
                restraurantDelegate::gettableState(tableState_DISABLE).colorname1,
                3).name();
