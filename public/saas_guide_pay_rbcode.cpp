    ...
    ui(new Ui::saas_guide_pay_rbcode)
{
    ...
    timer.start();
    setWindowTitle(tr("支付") + ":" + QString::number(fee, 'f', 2));
}
...
void saas_guide_pay_rbcode::generRbCode()
{
    ...
    if(alipay_help::alipay_trade_precreate(arg0,arg1,arg2)) {
        ui->label_alipay->setPixmap(
                    testwx_help::get_rbcode(arg2.qr_code_not_null.toLocal8Bit().data(), ui->label_alipay->width()));
    } else {
        lds_messagebox::warning(this, MESSAGE_TITLE_VOID,  tr("支付宝") + tr("操作失败") + "\n" + alipay_help::errstring);
    }
    ...
    if(testwx_help::AmountQRcodeRequest(
        ...
        lds_messagebox::warning(this, MESSAGE_TITLE_VOID,  tr("微信") + tr("操作失败"));
    }
}
...
void saas_guide_pay_rbcode::check_pay()
{
    ...
    if(alipay_help::alipay_trade_query(arg0, arg1, arg2)){
        if(!arg2.trade_no_not_null.isEmpty()
            ...
            lds_messagebox::information(this, MESSAGE_TITLE_VOID, tr("支付宝") + "," + tr("支付成功"));
            this->accept();
            return;
        }
    }
    ...
    if(!wechatd.transaction_id.trimmed().isEmpty()
        ...
        lds_messagebox::information(this, MESSAGE_TITLE_VOID, tr("微信") + "," + tr("支付成功"));
        this->accept();
        return;
    }
