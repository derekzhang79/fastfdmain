...
public:
    ...
    static bool networkSkipHttpData(const networkHttpRequest::httpData &d, const QString &url);
    static QString networkFilterHttpUrl(const QString &url);
    static QString terminalCodeGet();
    static QString hostNameGet();
    ...
    static QString saas_Host();

    static bool saas_update_adv(const QString &dir, lds_messagebox_loading_show *loading);

    static void paintLeftTop(QWidget *widget, const QRect &rect0, QPainter *painter);
    static void paintLeftTopAA(QWidget *widget, const QRect &rect0, QPainter *painter);
...
private:
    ...
    static QWidgetList signWidgetList;
