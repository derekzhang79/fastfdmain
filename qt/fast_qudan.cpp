    ...
    ui(new Ui::fast_qudan)
{
    ...
    querymodel->setHeaderData(0, Qt::Horizontal, tr("挂单号"));
    ...
    querymodel_2->setHeaderData(0, Qt::Horizontal, tr("操作员"));
    querymodel_2->setHeaderData(1, Qt::Horizontal, tr("品名"));
    querymodel_2->setHeaderData(2, Qt::Horizontal, tr("价格"));
    querymodel_2->setHeaderData(3, Qt::Horizontal, tr("数量"));
...
bool fast_qudan::take(QString &errstring, fexpandmain_model_sqltablemodel_data *tablemodel, int int_flowid)
{
    lds_query query;
    ///
    tablemodel->keepdata_disabled_begin_rowcount(0);
...
void fast_qudan::todel()
{
    ...
    if(0 == lds_messagebox::question(this, MESSAGE_TITLE_VOID, tr("是否删除"), tr("是"),  tr("否"))) {
