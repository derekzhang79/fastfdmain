...
class w_scr_dish_restaurant_dialog : public lds_roundeddialog_rect0
{
    Q_OBJECT
public:
    static bool cey_bt_table_bar_replace(const QString &ch_tableno, int int_div_id, const QString &ch_billno);
    static bool cey_bt_table_bar_replace(lds_query query, const QString &ch_tableno, int int_div_id, const QString &ch_billno);
