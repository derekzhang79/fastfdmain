    ...
    QDialog(parent)
{
    ...
    ui->tableView_table->updateFixed_fillData_addAnimation(4, 8, 90, 90);
...
QString w_scr_dish_restaurant_table_select::get_ch_billno()
{
    ...
    return w_scr_dish_restaurant_div_pop::cey_bt_table_ch_billno_get(ch_tableno, ch_divno);
}
