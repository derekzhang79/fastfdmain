...
static QString trans_g2u(char *data)
{
    QTextCodec *c = QTextCodec::codecForName("gb2312");//gb2312->uft-8
...
bool alipay_help::check(const alipay_help::alipay_public_request_argument &d)
{
    ...
    if(d.method_not_null.isEmpty()){ errstring = "method_not_null"; return false; }
...
bool alipay_help::resolve_data(const QByteArray &data, alipay_help::alipay_trade_query_return_argument &retvalue)
{
    ...
    if(retvalue.trade_no_not_null.isEmpty()
        ...
        if(item0){
            ...
            info =  trans_g2u(item0->valuestring);
        }
        //
        flag = false;
    }
...
{
    ((alipay_public_request_argument *)&arg0)->method_not_null = "alipay.trade.pay";
    //判断arg0和arg1是否符合规范
    if(check(arg0)
            &&check(arg1)){
        ...
        if(!arg0.method_not_null.isEmpty())content.insert("method", arg0.method_not_null);
...
{
    ((alipay_public_request_argument *)&arg0)->method_not_null = "alipay.trade.precreate";
    //判断arg0和arg1是否符合规范
    if(check(arg0)
            &&check(arg1)){
        //判断arg1.goods_detail是否符合规范
...
{
    ((alipay_public_request_argument *)&arg0)->method_not_null = "alipay.trade.query";
    //判断arg0和arg1是否符合规范
    if(check(arg1)
            &&check(arg0)){
        QMap<QString, QString> content;
...
{
    ((alipay_public_request_argument *)&arg0)->method_not_null = "alipay.trade.refund";
    //判断arg0和arg1是否符合规范
    if(check(arg0)
            &&check(arg1)){
        QMap<QString, QString> content;
